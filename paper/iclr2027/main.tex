...
was evaluated on three models; the remaining nine ladder models lack split-half
intervention measurements. Disattenuation applies half-sample reliabilities to
pooled correlations, meaning adjusted values serve as diagnostic bounds alongside
raw values rather than corrected ground truth. Rank correlations describe
within-sample monotonicity rather than out-of-sample prediction.
